...
#define S5K5CAGX_SENSOR_NAME "s5k5cagx"
...
#define BENZ_TEMP_MASK


DEFINE_MSM_MUTEX(s5k5cagx_mut);
static struct msm_sensor_ctrl_t s5k5cagx_s_ctrl;


static struct msm_sensor_power_setting s5k5cagx_power_setting[] = {
...
static struct msm_sensor_power_setting s5k5cagx_power_down_setting[] = {
	{
		.seq_type = SENSOR_I2C_MUX,
		.seq_val = 0,
		.config_val = 0,
...
/* capture setting */
static struct msm_camera_i2c_reg_conf s5k5cagx_2048x1536_settings[] = {
...
/* preview  setting */
static struct msm_camera_i2c_reg_conf s5k5cagx_1024x768_settings[] = {
...
static struct msm_camera_i2c_reg_conf s5k5cagx_start_settings[] = {
	//{0x03, 0x00},
	//{0x01, 0x00},

};

static struct msm_camera_i2c_reg_conf s5k5cagx_stop_settings[] = {
	//{0x03, 0x00},
	//{0x01, 0x01},

};

static struct msm_camera_i2c_reg_conf s5k5cagx_recommend_settings_step0[] = {
//#ARM GO
  //#Direct mode
  {0xFCFC, 0xD000},
  {0x0010, 0x0001},  //Reset
  ...
  {0xFFFF, 0x64FF},  //p100 //delay 100ms
  ...
  {0x0028, 0x7000},
  {0x002A, 0x01CC},
  {0x0F12, 0X5DC0},  //5FB4 // #REG_TC_IPRM_InClockLSBs  //Set input CLK // 20MHz yybin
  ...
  {0x002A, 0x01F6},
  {0x0F12, 0x2ee0},  //REG_TC_IPRM_OpClk4KHz_0                   	2   700001F6
  {0x0F12, 0x32A8},  //3
  {0x0F12, 0x32E8},
  ...
  {0x0F12, 0x4268},  //REG_TC_IPRM_MinOutRate4KHz_2              	2   70000204
  {0x0F12, 0x445C},  //REG_TC_IPRM_MaxOutRate4KHz_2              	2   70000206
    //Updat        
  {0x002A, 0x0208},
  {0x0F12, 0x0001},  // #REG_TC_IPRM_InitParamsUpdated
    ...
    // How t       
    // 1. Ere value
    // dec21 / (frame rate you want(ms))) * 100d * 4d)
    // 2. A Digital gain
    // dec2Analog gain you want) * 256d)
    //=======================================================
    // Set ew exposure time
  {0x002A, 0x0530},
  ...
  {0x0F12, 0x0000},
  {0x0F12, 0xD055},  // #evt1_lt_uMaxExp4	133ms
  {0x0F12, 0x0000},
    // Set re exposure time
  {0x002A, 0x0538},
  ...
  {0x002A, 0x0544},
  {0x0F12, 0x0180},  // #lt_uMaxDigGain
  {0x0F12, 0x0b00},  //#lt_uMaxTotGain
  {0x002A, 0x1694},
  {0x0F12, 0x0001},  // #evt1_senHal_bExpandForbid
    //delay        
    //==========================================================================================
    //SET PW CONFIGURATION_0
    //# For YUV422 
    //# Siz24*768  
    //# FPS~15fps for normal mode
    //==========================================================================================
  {0x002A, 0x026C},
  ...
  {0x0F12, 0x0010},  //0052 //#REG_0TC_PCFG_PVIMask //s0050 = FALSE in MSM6290 : s0052 = TRUE in MSM6800 //reg 027A
...
#if 1
  {0x0F12, 0x0197},  //#REG_0TC_PCFG_usMaxFrTimeMsecMult10 //10fps  zhangjun
  {0x0F12, 0x0197},  //01C6 //#REG_0TC_PCFG_usMinFrTimeMsecMult10 //22fps
#else
//case 1: auto
//  {0x0F12, 0x03E8},  //#REG_0TC_PCFG_usMaxFrTimeMsecMult10
//  {0x0F12, 0x0197},  //01C6 //#REG_0TC_PCFG_usMinFrTimeMsecMult10

//case 2: 15fps
  {0x0F12, 0x029A},  //#REG_0TC_PCFG_usMaxFrTimeMsecMult10
  {0x0F12, 0x029A},  //01C6 //#REG_0TC_PCFG_usMinFrTimeMsecMult10
#endif
  ...
  // < DTS22405731 tangying 20111224 begin */
  #if defined(HUAWEI_PRODUCT_LITE2)
 ...
 //==========================================================================================
 //SET PREVONFIGURATION_1
 //# ForamtV422    
 //# Size:         
 //# FPS : ps for Night mode
 //==========================================================================================
  {0x002A, 0x029C}, 
  {0x0F12, 0x0400},  //#REG_1TC_PCFG_usWidth//1024
  {0x0F12, 0x0300},  //#REG_1TC_PCFG_usHeight //768	 026E
  {0x0F12, 0x0005},  //#REG_1TC_PCFG_Format			0270
  {0x0F12, 0x32E8},  //#REG_1TC_PCFG_usMaxOut4KHzRate  0272
  {0x0F12, 0x32a8},  //#REG_1TC_PCFG_usMinOut4KHzRate  0274
  {0x0F12, 0x0100},  //#REG_1TC_PCFG_OutClkPerPix88	0276
  {0x0F12, 0x0800},  //#REG_1TC_PCFG_uMaxBpp88 		027
  {0x0F12, 0x0010},  //#REG_1TC_PCFG_PVIMask //s0050 = FALSE in MSM6290 : s0052 = TRUE in MSM6800 //reg 027A
  {0x0F12, 0x0010},  //#REG_1TC_PCFG_OIFMask
  ...
  {0x0F12, 0x0001},
  {0x0F12, 0x07D0},  //#REG_1TC_PCFG_usMaxFrTimeMsecMult10 //5fps
  {0x0F12, 0x029A},  //#REG_1TC_PCFG_usMinFrTimeMsecMult10 //22fps
  ...
  {0x0F12, 0x0000},  //#REG_0TC_PCFG_uCaptureMirror  0x0003
  #else
  //{0x0F12, 0x0003},  //#REG_1TC_PCFG_uPrevMirror  0x0003
  //{0x0F12, 0x0003},  //#REG_1TC_PCFG_uCaptureMirror  0x0003
  {0x0F12, 0x0000},  //#REG_1TC_PCFG_uPrevMirror  0x0003
  {0x0F12, 0x0000},  //#REG_1TC_PCFG_uCaptureMirror  0x0003
  #endif
  // DTS20105731 tangying 20111224 end > */
  {0x0F12, 0x0000},  //#REG_1TC_PCFG_uRotation
  //==========================================================================================                
  //SET PRECONFIGURATION_1
  //# ForamUV422
  //# Size:*1536
  //# FPS :
  //==========================================================================================                  
   {0x002A, 0x02CC},
   {0x0F12, 0x0500},  //#REG_1TC_PCFG_usWidth//1024
   {0x0F12, 0x02D0},  //#REG_1TC_PCFG_usHeight //768	 026E
   {0x0F12, 0x0005},  //#REG_1TC_PCFG_Format			0270
   {0x0F12, 0x445c},  //#REG_1TC_PCFG_usMaxOut4KHzRate  0272
   {0x0F12, 0x4268},  //#REG_1TC_PCFG_usMinOut4KHzRate  0274
   {0x0F12, 0x0100},  //#REG_1TC_PCFG_OutClkPerPix88	0276
   {0x0F12, 0x0800},  //#REG_1TC_PCFG_uMaxBpp88 		027
   {0x0F12, 0x0010},  //#REG_1TC_PCFG_PVIMask //s0050 = FALSE in MSM6290 : s0052 = TRUE in MSM6800 //reg 027A
   {0x0F12, 0x0010},  //#REG_1TC_PCFG_OIFMask
   {0x0F12, 0x01E0},  //#REG_1TC_PCFG_usJpegPacketSize
   {0x0F12, 0x0000},  //#REG_1TC_PCFG_usJpegTotalPackets
   {0x0F12, 0x0002},  //#REG_1TC_PCFG_uClockInd
   {0x0F12, 0x0000},  //#REG_1TC_PCFG_usFrTimeType
   {0x0F12, 0x0002},
   {0x0F12, 0x029a},  //#REG_1TC_PCFG_usMaxFrTimeMsecMult10 //5fps
   {0x0F12, 0x029a}, //#REG_1TC_PCFG_usMinFrTimeMsecMult10 //22fps
   {0x0F12, 0x0000},  //#REG_1TC_PCFG_bSmearOutput
   {0x0F12, 0x0000},  //#REG_1TC_PCFG_sSaturation
   {0x0F12, 0x0000},  //#REG_1TC_PCFG_sSharpBlur
 ...
 //========================================================================================== 
  {0x002A, 0x02FC},
  {0x0F12, 0x0800},  //#REG_1TC_PCFG_usWidth//1024
  {0x0F12, 0x0600},  //#REG_1TC_PCFG_usHeight //768	 026E
  {0x0F12, 0x0005},  //#REG_1TC_PCFG_Format			0270
  {0x0F12, 0x32e8},  //#REG_1TC_PCFG_usMaxOut4KHzRate  0272
  {0x0F12, 0x32a8},  //#REG_1TC_PCFG_usMinOut4KHzRate  0274
  {0x0F12, 0x0100},  //#REG_1TC_PCFG_OutClkPerPix88	0276
  ...
  {0x0F12, 0x0002},
 #if 0
  {0x0F12, 0x0535},  //#REG_1TC_PCFG_usMaxFrTimeMsecMult10 //5fps
  {0x0F12, 0x0535}, //#REG_1TC_PCFG_usMinFrTimeMsecMult10 //22fps
 #else
 {0x0F12, 0x07D0},  //#REG_1TC_PCFG_usMaxFrTimeMsecMult10 //5fps
 {0x0F12, 0x07D0}, //#REG_1TC_PCFG_usMinFrTimeMsecMult10 //22fps
 #endif
  {0x0F12, 0x0000},  //#REG_1TC_PCFG_bSmearOutput
  {0x0F12, 0x0000},  //#REG_1TC_PCFG_sSaturation
  {0x0F12, 0x0000},  //#REG_1TC_PCFG_sSharpBlur
...
//==========================================================================================
//APPLY PRECONFIGURATION & RUN PREVIEW
//==========================================================================================
  {0x002A, 0x023C}, 
  ...
  // DTS20105017 cuixuefeng 20120510 end > */
  ...
  {0x0028, 0x7000},
  {0x002A, 0x0F70},
  {0x0F12, 0x0044},  //#TVAR_ae_BrAve 091222  zhangjun
    // AE mode     
  {0x002A, 0x0F76},
  {0x0F12, 0x0001},  //Disable illumination & contrast  // #ae_StatMode
  {0x002A, 0x051A},
  ...
  {0x002A, 0x06CE},
  {0x0F12, 0x0120},  // #TVAR_ash_GASAlpha[0] // Horizon
  {0x0F12, 0x0100},  // #TVAR_ash_GASAlpha[1]
  {0x0F12, 0x0100},  // #TVAR_ash_GASAlpha[2]
  {0x0F12, 0x00e0},  // #TVAR_ash_GASAlpha[3]
  {0x0F12, 0x0120},  // #TVAR_ash_GASAlpha[4] // IncandA
  ...
  {0x0F12, 0x0100},  // #TVAR_ash_AwbAshCord_1_
  {0x0F12, 0x0110},  // #TVAR_ash_AwbAshCord_2_
  {0x0F12, 0x0120},  // #TVAR_ash_AwbAshCord_3_
  ...
  {0x0F12, 0x0094},  //0159  //012F //#TVAR_wbt_pBaseCcms[71]
    // D50         
  {0x0F12, 0x01A3},  //01C8  //#TVAR_wbt_pBaseCcms[72]
  {0x0F12, 0xFFBA},  //FF7F  //#TVAR_wbt_pBaseCcms[73]
  {0x0F12, 0xFFFB},  //FFE4  //#TVAR_wbt_pBaseCcms[74]
  {0x0F12, 0xFF40},  //#TVAR_wbt_pBaseCcms[75]
  {0x0F12, 0x0255},  //#TVAR_wbt_pBaseCcms[76]
  {0x0F12, 0xFF90},  //#TVAR_wbt_pBaseCcms[77]
  {0x0F12, 0x0012},  //FFDF  //#TVAR_wbt_pBaseCcms[78]
  {0x0F12, 0xFFE6},  //FFE9  //#TVAR_wbt_pBaseCcms[79]
  {0x0F12, 0x01FF},  //01BD  //#TVAR_wbt_pBaseCcms[80]
  ...
  {0x0F12, 0x0094},  //#TVAR_wbt_pBaseCcms[89]
    //  D65        
  {0x0F12, 0x01A3},  //01DC  //01C8 //#TVAR_wbt_pBaseCcms[90]
  {0x0F12, 0xFFBA},  //FF76  //FF7F //#TVAR_wbt_pBaseCcms[91]
  {0x0F12, 0xFFFB},  //FFE0  //FFE4 //#TVAR_wbt_pBaseCcms[92]
  {0x0F12, 0xFF40},  //FF4F  //#TVAR_wbt_pBaseCcms[93]
  {0x0F12, 0x0255},  //01F5  //#TVAR_wbt_pBaseCcms[94]
  {0x0F12, 0xFF90},  //FF77  //#TVAR_wbt_pBaseCcms[95]
  {0x0F12, 0x0012},  //FFCA  //FFDF //#TVAR_wbt_pBaseCcms[96]
  {0x0F12, 0xFFE6},  //FFD5  //FFE9 //#TVAR_wbt_pBaseCcms[97]
  {0x0F12, 0x01FF},  //01EC  //01BD //#TVAR_wbt_pBaseCcms[98]
...
#if 0  
  {0x0F12, 0x020E},       //TVAR_wbt_pOutdoorCcm[0] //  
{0x0F12, 0xFF88},       //TVAR_wbt_pOutdoorCcm[1] //  
{0x0F12, 0xFFCE},       //TVAR_wbt_pOutdoorCcm[2] //  
{0x0F12, 0xFE3D},       //TVAR_wbt_pOutdoorCcm[3] //  
{0x0F12, 0x0158},       //TVAR_wbt_pOutdoorCcm[4] //  
{0x0F12, 0xFF03},       //TVAR_wbt_pOutdoorCcm[5] //  
{0x0F12, 0xFF99},       //TVAR_wbt_pOutdoorCcm[6] //  
{0x0F12, 0x0018},       //TVAR_wbt_pOutdoorCcm[7] //  
{0x0F12, 0x0235},       //TVAR_wbt_pOutdoorCcm[8] //  
{0x0F12, 0x0101},       //TVAR_wbt_pOutdoorCcm[9] //  
{0x0F12, 0x0116},       //TVAR_wbt_pOutdoorCcm[10] // 
{0x0F12, 0xFF00},       //TVAR_wbt_pOutdoorCcm[11] // 
{0x0F12, 0x01C5},       //TVAR_wbt_pOutdoorCcm[12] // 
{0x0F12, 0xFF80},       //TVAR_wbt_pOutdoorCcm[13] // 
{0x0F12, 0x019D},       //TVAR_wbt_pOutdoorCcm[14] // 
{0x0F12, 0xFE7A},       //TVAR_wbt_pOutdoorCcm[15] // 
{0x0F12, 0x0179},       //TVAR_wbt_pOutdoorCcm[16] // 
{0x0F12, 0x0179},       //TVAR_wbt_pOutdoorCcm[17] // 
#else
{0x0F12, 0x0204},       //TVAR_wbt_pOutdoorCcm[0] //  
{0x0F12, 0xFFCE},       //TVAR_wbt_pOutdoorCcm[1] //  
{0x0F12, 0xFFF1},       //TVAR_wbt_pOutdoorCcm[2] // 

{0x0F12, 0xFF50},       //TVAR_wbt_pOutdoorCcm[3] //  
{0x0F12, 0x0269},       //TVAR_wbt_pOutdoorCcm[4] //  
{0x0F12, 0xFF27},       //TVAR_wbt_pOutdoorCcm[5] //

{0x0F12, 0x0023},       //TVAR_wbt_pOutdoorCcm[6] //  
{0x0F12, 0x0050},       //TVAR_wbt_pOutdoorCcm[7] //  
{0x0F12, 0x020E},       //TVAR_wbt_pOutdoorCcm[8] //  
{0x0F12, 0x00BF},       //TVAR_wbt_pOutdoorCcm[9] //  
{0x0F12, 0x00DE},       //TVAR_wbt_pOutdoorCcm[10] // 
{0x0F12, 0xFF3F},       //TVAR_wbt_pOutdoorCcm[11] // 
{0x0F12, 0x01C5},       //TVAR_wbt_pOutdoorCcm[12] // 
{0x0F12, 0xFF80},       //TVAR_wbt_pOutdoorCcm[13] // 
{0x0F12, 0x019D},       //TVAR_wbt_pOutdoorCcm[14] // 
{0x0F12, 0xFEAF},       //TVAR_wbt_pOutdoorCcm[15] // 
{0x0F12, 0x0137},       //TVAR_wbt_pOutdoorCcm[16] // 
{0x0F12, 0x00E5},       //TVAR_wbt_pOutdoorCcm[17] // 
#endif
    //White balance
  ...
  {0x0F12, 0x0000}, 
  {0x002A, 0x0D46}, 
  {0x0F12, 0x0470}, //0470 //awbb_MvEq_RBthresh
  {0x002A, 0x0D5C}, 
  {0x0F12, 0x7FFF}, //0534 //awbb_LowTempRB
  {0x0F12, 0x0050},
  
  {0x002A, 0x0D28},
  {0x0F12, 0x0270}, //wp outdoor
  {0x0F12, 0x0240},
  ...
  {0x0F12, 0x0000},  //awbb_GridCorr_R[17]
    //	pard	awbb_GridCorr_R
    //	parart	awbb_GridCorr_B
  {0x002A, 0x0DF8}, 
  ...
  {0x0F12, 0x0000},  //awbb_GridCorr_B[17]
    //	pard	awbb_GridCorr_B
//#if 1 //fst      
  {0x0028, 0x7000}, 
  {0x002A, 0x0D44}, 
  {0x0F12, 0x0014},    //awbb_MinNumOfChromaClassifyPatches
  {0x002A, 0x0DCC}, 
  {0x0F12, 0x0001},    // awbb_GnMinMatchToJump
    //{0x00C6      
    //{0x0F14    // awbb_GnFarPntImmunity
    //{0x00C8      
    //{0x0F19    //  awbb_GnCurPntImmunity
    //{0x0042      
    //{0x0F71    //awbb_Use_Filters
  {0x002A, 0x0DCA}, 
  {0x0F12, 0x04B0},    //awbb_GainsMaxMove
    //{0x0040      
    //{0x0F01    //   awbb_UseGrThrCorr  
  ...
  {0x002A, 0x0D88},
  {0x0F12, 0x0038}, //#awbb_OutdoorDetectionZone_m_BGrid[0]_m_lef
  {0x0F12, 0x0074}, //#awbb_OutdoorDetectionZone_m_BGrid[0]_m_rig
  {0x0F12, 0xFFF1}, //#awbb_OutdoorDetectionZone_m_BGrid[1]_m_lef
  {0x0F12, 0x00BF}, //#awbb_OutdoorDetectionZone_m_BGrid[1]_m_rig
  {0x0F12, 0xFF9B}, //#awbb_OutdoorDetectionZone_m_BGrid[2]_m_lef
  {0x0F12, 0x00DB}, //#awbb_OutdoorDetectionZone_m_BGrid[2]_m_rig
  {0x0F12, 0xFF56}, //#awbb_OutdoorDetectionZone_m_BGrid[3]_m_lef
  {0x0F12, 0x00F0}, //#awbb_OutdoorDetectionZone_m_BGrid[3]_m_rig
  {0x0F12, 0xFEFF}, //#awbb_OutdoorDetectionZone_m_BGrid[4]_m_lef
  {0x0F12, 0x010F}, //#awbb_OutdoorDetectionZone_m_BGrid[4]_m_rig
  {0x0F12, 0x0E74}, //#awbb_OutdoorDetectionZone_ZInfo_m_AbsGridS

  {0x002A, 0x0DA8},
  {0x0F12, 0x14B8},  //awbb_OutdoorDetectionZone_ZInfo_m_MaxNBNB
  {0x002A, 0x0DA4},
  {0x0F12, 0x274E},  //awbb_OutdoorDetectionZone_ZInfo_m_NBoffs
  
  {0x002A, 0x0D4C},
  {0x0F12, 0x0187}, //0653    // #awbb_GamutWidthThr1
  {0x0F12, 0x00CF}, //02EB   // #awbb_GamutHeightThr1
  {0x0F12, 0x000D}, //002C   // #awbb_GamutWidthThr2
  {0x0F12, 0x000A}, //000B   // #awbb_GamutHeightThr2


#if 0
  {0x002A, 0x0E36, 0x00,  2},
  {0x0F12, 0x0038, 0x00,  2},
  {0x0F12, 0xFFD8, 0x00,  2},
  ...
  {0x0F12, 0x0375},  //0394	//#SARR_usDualGammaLutRGBIndoor_0__17_ 0x700032AA
  {0x0F12, 0x03A2},  //03CE	//#SARR_usDualGammaLutRGBIndoor_0__18_ 0x700032AC
  {0x0F12, 0x03CA},  //03FF	//#SARR_usDualGammaLutRGBIndoor_0__19_ 0x700032AE
  ...
  {0x0F12, 0x0375},  //0394	//#SARR_usDualGammaLutRGBIndoor_1__17_ 0x700032D2
  {0x0F12, 0x03A2},  //03CE	//#SARR_usDualGammaLutRGBIndoor_1__18_ 0x700032D4
  {0x0F12, 0x03CA},  //03FF	//#SARR_usDualGammaLutRGBIndoor_1__19_ 0x700032D6
  ...
  {0x0F12, 0x0375},  //0394	//#SARR_usDualGammaLutRGBIndoor_2__17_ 0x700032FA
  {0x0F12, 0x03A2},  //03CE	//#SARR_usDualGammaLutRGBIndoor_2__18_ 0x700032FC
  {0x0F12, 0x03CA},  //03FF	//#SARR_usDualGammaLutRGBIndoor_2__19_ 0x700032FE
  ...
  {0x0F12, 0x0375},  //#SARR_usDualGammaLutRGBOutdoor_0__17_0x70003322
  {0x0F12, 0x03A2},  //#SARR_usDualGammaLutRGBOutdoor_0__18_0x70003324
  {0x0F12, 0x03CA},  //#SARR_usDualGammaLutRGBOutdoor_0__19_0x70003326
  ...
  {0x0F12, 0x0375},  //#SARR_usDualGammaLutRGBOutdoor_1__17_0x7000334A
  {0x0F12, 0x03A2},  //#SARR_usDualGammaLutRGBOutdoor_1__18_0x7000334C
  {0x0F12, 0x03CA},  //#SARR_usDualGammaLutRGBOutdoor_1__19_0x7000334E
  ...
  {0x0F12, 0x0375},  //#SARR_usDualGammaLutRGBOutdoor_2__17_0x70003372
  {0x0F12, 0x03A2},  //#SARR_usDualGammaLutRGBOutdoor_2__18_0x70003374
  {0x0F12, 0x03CA},  //#SARR_usDualGammaLutRGBOutdoor_2__19_0x70003376
  {0x002A, 0x06A6}, 
  {0x0F12, 0x00C0},  // #SARR_AwbCcmCord_0_
  {0x0F12, 0x0100},  // #SARR_AwbCcmCord_1_
  ...
  {0x0F12, 0xFFF6},  //700007CA //TVAR_afit_pBaseValS[3] // AFIT16_SHARP_BLUR
  ...
  {0x0F12, 0x0023},  //700007F4 //TVAR_afit_pBaseValS[24] //AFIT16_Sharpening_iLowSharpClamp
  ...
  {0x0F12, 0x0A06},  //7000081E //TVAR_afit_pBaseValS[45] //AFIT8_Demosaicing_iNearGrayDesat[7:0],	AFIT8_Demosaicing_iDFD_ReduceCoeff [15:8]
  {0x0F12, 0x052d},  //70000820 //TVAR_afit_pBaseValS[46] //AFIT8_Sharpening_iMSharpen [7:0],   AFIT8_Sharpening_iMShThresh [15:8]
  {0x0F12, 0x0514},  //70000822 //TVAR_afit_pBaseValS[47] //AFIT8_Sharpening_iWSharpen [7:0],   AFIT8_Sharpening_iWShThresh [15:8]
  ...
  {0x0F12, 0x3203},  //70000834 //TVAR_afit_pBaseValS[56] //AFIT8_YUV422_DENOISE_iYSupport [7:0],   AFIT8_byr_cgras_iShadingPower [15:8]
  {0x0F12, 0x006E},  //70000836 //TVAR_afit_pBaseValS[57] //AFIT8_RGBGamma2_iLinearity [7:0],  AFIT8_RGBGamma2_iDarkReduce [15:8]
  {0x0F12, 0x0878},  //70000838 //TVAR_afit_pBaseValS[58] //AFIT8_ccm_oscar_iSaturation[7:0],   AFIT8_RGB2YUV_iYOffset [15:8]
  ...
  {0x0F12, 0x875a},  //70000842 //TVAR_afit_pBaseValS[63] //AFIT8_sddd8a_DispTH_High [7:0],	 AFIT8_sddd8a_iDenThreshLow [15:8]
  {0x0F12, 0x2887},  //70000844 //TVAR_afit_pBaseValS[64] //AFIT8_sddd8a_iDenThreshHigh[7:0],   AFIT8_Demosaicing_iEdgeDesat [15:8]
  ...
  {0x0F12, 0x2d04},  //70000850 //TVAR_afit_pBaseValS[70] //AFIT8_Demosaicing_iDemBlurRange[7:0],   AFIT8_Sharpening_iLowSharpPower [15:8]
  {0x0F12, 0x192d},  //70000852 //TVAR_afit_pBaseValS[71] //AFIT8_Sharpening_iHighSharpPower[7:0],	AFIT8_Sharpening_iLowShDenoise [15:8]
  {0x0F12, 0x4019},  //70000854 //TVAR_afit_pBaseValS[72] //AFIT8_Sharpening_iHighShDenoise [7:0],	AFIT8_Sharpening_iReduceEdgeMinMult [15:8]
  ...
  {0x0F12, 0xFFF8},  //7000089A //TVAR_afit_pBaseValS[107] /AFIT16_SHARP_BLUR
  ...
  {0x0F12, 0x0028},  //700008C4 //TVAR_afit_pBaseValS[128] /AFIT16_Sharpening_iLowSharpClamp
  {0x0F12, 0x0010},  //700008C6 //TVAR_afit_pBaseValS[129] /AFIT16_Sharpening_iHighSharpClamp
  ...
  {0x0F12, 0x0A06},  //700008EE //TVAR_afit_pBaseValS[149] /AFIT8_Demosaicing_iNearGrayDesat[7:0],	AFIT8_Demosaicing_iDFD_ReduceCoeff [15:8]
  {0x0F12, 0x0632},  //700008F0 //TVAR_afit_pBaseValS[150] /AFIT8_Sharpening_iMSharpen [7:0],   AFIT8_Sharpening_iMShThresh [15:8]
  {0x0F12, 0x0514},  //700008F2 //TVAR_afit_pBaseValS[151] /AFIT8_Sharpening_iWSharpen [7:0],   AFIT8_Sharpening_iWShThresh [15:8]
  ...
  {0x0F12, 0x3703},  //70000904 //TVAR_afit_pBaseValS[160] /AFIT8_YUV422_DENOISE_iYSupport [7:0],   AFIT8_byr_cgras_iShadingPower [15:8]
  {0x0F12, 0x006e},  //70000906 //TVAR_afit_pBaseValS[161] /AFIT8_RGBGamma2_iLinearity [7:0],  AFIT8_RGBGamma2_iDarkReduce [15:8]
  {0x0F12, 0x0878},  //70000908 //TVAR_afit_pBaseValS[162] /AFIT8_ccm_oscar_iSaturation[7:0],   AFIT8_RGB2YUV_iYOffset [15:8]
  ...
  {0x0F12, 0x4602},  //70000910 //TVAR_afit_pBaseValS[166] /AFIT8_sddd8a_nClustLevel_H [7:0],   AFIT8_sddd8a_DispTH_Low [15:8]
  {0x0F12, 0x8046},  //70000912 //TVAR_afit_pBaseValS[167] /AFIT8_sddd8a_DispTH_High [7:0],	 AFIT8_sddd8a_iDenThreshLow [15:8]
  {0x0F12, 0x2880},  //70000914 //TVAR_afit_pBaseValS[168] /AFIT8_sddd8a_iDenThreshHigh[7:0],   AFIT8_Demosaicing_iEdgeDesat [15:8]
  ...
  {0x0F12, 0x192d},  //70000922 //TVAR_afit_pBaseValS[175] /AFIT8_Sharpening_iHighSharpPower[7:0],	AFIT8_Sharpening_iLowShDenoise [15:8]
  {0x0F12, 0x4019},  //70000924 //TVAR_afit_pBaseValS[176] /AFIT8_Sharpening_iHighShDenoise [7:0],	AFIT8_Sharpening_iReduceEdgeMinMult [15:8]
  ...
  {0x0F12, 0x0017},  //70000996 //TVAR_afit_pBaseValS[233] /AFIT16_Sharpening_iHighSharpClamp
  ...
  {0x0F12, 0x0A04},  //700009BE //TVAR_afit_pBaseValS[253] /AFIT8_Demosaicing_iNearGrayDesat[7:0],	AFIT8_Demosaicing_iDFD_ReduceCoeff [15:8]
  {0x0F12, 0x0837},  //700009C0 //TVAR_afit_pBaseValS[254] /AFIT8_Sharpening_iMSharpen [7:0],   AFIT8_Sharpening_iMShThresh [15:8]
  ...
  {0x0F12, 0x4b03},  //700009D4 //TVAR_afit_pBaseValS[264] /AFIT8_YUV422_DENOISE_iYSupport [7:0],   AFIT8_byr_cgras_iShadingPower [15:8]
  ...
  {0x0F12, 0x3202},  //700009E0 //TVAR_afit_pBaseValS[270] /AFIT8_sddd8a_nClustLevel_H [7:0],   AFIT8_sddd8a_DispTH_Low [15:8]
  {0x0F12, 0x5532},  //700009E2 //TVAR_afit_pBaseValS[271] /AFIT8_sddd8a_DispTH_High [7:0],	 AFIT8_sddd8a_iDenThreshLow [15:8]
  {0x0F12, 0x2855},  //700009E4 //TVAR_afit_pBaseValS[272] /AFIT8_sddd8a_iDenThreshHigh[7:0],   AFIT8_Demosaicing_iEdgeDesat [15:8]
  ...
  {0x0F12, 0x3c04},  //700009F0 //TVAR_afit_pBaseValS[278] /AFIT8_Demosaicing_iDemBlurRange[7:0],   AFIT8_Sharpening_iLowSharpPower [15:8]
  {0x0F12, 0x0F32},  //700009F2 //TVAR_afit_pBaseValS[279] /AFIT8_Sharpening_iHighSharpPower[7:0],	AFIT8_Sharpening_iLowShDenoise [15:8]
  ...
  {0x0F12, 0x0023},  //70000A38 //TVAR_afit_pBaseValS[314] /AFIT16_SATURATION
  ...
  {0x0F12, 0x5a02},  //4602  //// #TVAR_afit_pBaseVals[368]
  ...
  {0x0F12, 0x0023},  //70000B08 //TVAR_afit_pBaseValS[418] /AFIT16_SATURATION
  ...
  {0x0F12, 0x0A04},  //70000B5E //TVAR_afit_pBaseValS[461] /AFIT8_Demosaicing_iNearGrayDesat[7:0],	AFIT8_Demosaicing_iDFD_ReduceCoeff [15:8]
  ...
  {0x0F12, 0x6402},  //70000B74 //TVAR_afit_pBaseValS[472] /AFIT8_YUV422_DENOISE_iYSupport [7:0],   AFIT8_byr_cgras_iShadingPower [15:8]
  ...
  {0x0F12, 0x00e2},  //
    // UpdaP tuning parameters
  {0x002A, 0x337A}, 
  {0x0F12, 0x0006},  // #Tune_TP_atop_dbus_reg // 6 is the default HW value

  {0x0028, 0x7000},
  {0x002A, 0x0232},
  {0x0F12, 0x0800},  //REG_TC_GP_ReqInputWidth
  {0x0F12, 0x0600},  //0600  //REG_TC_GP_ReqInputHeight
  {0x0F12, 0x0000},  //0000  //REG_TC_GP_InputWidthOfs
  {0x0F12, 0x0000}, //0000   //REG_TC_GP_InputHeightOfs
  ...
  {0x0F12, 0x0600},  //0480  //#REG_0TC_CCFG_usHeight
  {0x002a, 0x0246},
  {0x0f12, 0x0001},
  {0x002A, 0x02FC},
  {0x0F12, 0x0800},
...
static struct v4l2_subdev_info s5k5cagx_subdev_info[] = {
	{
...
#ifndef BENZ_TEMP_MASK
static struct msm_camera_i2c_reg_conf s5k5cagx_sleep_settings[] = {0};

static struct msm_camera_i2c_reg_conf s5k5cagx_reg_saturation[11][3] = {0};

static struct msm_camera_i2c_reg_conf s5k5cagx_reg_contrast[11][3] = {0};

static struct msm_camera_i2c_reg_conf s5k5cagx_reg_sharpness[6][9] = {0};

static struct msm_camera_i2c_reg_conf s5k5cagx_reg_iso[7][3] = {0};

static struct msm_camera_i2c_reg_conf s5k5cagx_reg_exposure_compensation[5][2] = {0};

static struct msm_camera_i2c_reg_conf s5k5cagx_reg_antibanding[4][26] = {0};

static struct msm_camera_i2c_reg_conf s5k5cagx_reg_effect_normal[] = {0};

static struct msm_camera_i2c_reg_conf s5k5cagx_reg_effect_black_white[] = {0};

static struct msm_camera_i2c_reg_conf s5k5cagx_reg_effect_negative[] = {0};

static struct msm_camera_i2c_reg_conf s5k5cagx_reg_effect_old_movie[] = {0};

static struct msm_camera_i2c_reg_conf s5k5cagx_reg_effect_solarize[] = {0};

static struct msm_camera_i2c_reg_conf s5k5cagx_reg_effect_aqua[] = {0};

static struct msm_camera_i2c_reg_conf s5k5cagx_reg_scene_auto[] = {0};

static struct msm_camera_i2c_reg_conf s5k5cagx_reg_scene_portrait[] = {0};

static struct msm_camera_i2c_reg_conf s5k5cagx_reg_scene_landscape[] = {0};

static struct msm_camera_i2c_reg_conf s5k5cagx_reg_scene_night[] = {0};

static struct msm_camera_i2c_reg_conf s5k5cagx_reg_wb_auto[] = {0};

static struct msm_camera_i2c_reg_conf s5k5cagx_reg_wb_sunny[] = {0};

static struct msm_camera_i2c_reg_conf s5k5cagx_reg_wb_cloudy[] = {0};

static struct msm_camera_i2c_reg_conf s5k5cagx_reg_wb_office[] = {0};

static struct msm_camera_i2c_reg_conf s5k5cagx_reg_wb_home[] = {0};
#endif

static const struct i2c_device_id s5k5cagx_i2c_id[] = {
	{S5K5CAGX_SENSOR_NAME, (kernel_ulong_t)&s5k5cagx_s_ctrl},
	{ }
};

static int32_t msm_s5k5cagx_i2c_probe(struct i2c_client *client,
		const struct i2c_device_id *id)
{
	int rc;
	rc = msm_sensor_i2c_probe(client, id, &s5k5cagx_s_ctrl);
	if(rc==0)
	{
		;//productinfo_register(PRODUCTINFO_MAIN_CAMERA_ID,"s5k5cagx",NULL);
	}
	return rc;
}
...
static struct i2c_driver s5k5cagx_i2c_driver = {
	...
	.probe  = msm_s5k5cagx_i2c_probe,
	.driver = {
		.name = S5K5CAGX_SENSOR_NAME,
	},
};

static struct msm_camera_i2c_client s5k5cagx_sensor_i2c_client = {
	.addr_type = MSM_CAMERA_I2C_WORD_ADDR,
};

static const struct of_device_id s5k5cagx_dt_match[] = {
	{.compatible = "shinetech,s5k5cagx", .data = &s5k5cagx_s_ctrl},
	{}
};

MODULE_DEVICE_TABLE(of, s5k5cagx_dt_match);

static struct platform_driver s5k5cagx_platform_driver = {
	.driver = {
		.name = "shinetech,s5k5cagx",
		.owner = THIS_MODULE,
		.of_match_table = s5k5cagx_dt_match,
	},
};

static void s5k5cagx_i2c_write_table(struct msm_sensor_ctrl_t *s_ctrl,
		...
		int num)
{
	...
	for (i = 0; i < num; ++i) {
		...
		//printk("s5k5cagx_i2c_write_table reg_addr:%x reg_data:%x\n",table->reg_addr,temp);
		table++;
	}
}
...
#if 0
static int32_t s5k5cagx_sensor_power_down(struct msm_sensor_ctrl_t *s_ctrl)
{
	s5k5cagx_i2c_write_table(s_ctrl, &s5k5cagx_sleep_settings[0],
		ARRAY_SIZE(s5k5cagx_sleep_settings));
	return msm_sensor_power_down(s_ctrl);
}
#endif

static int32_t s5k5cagx_sensor_enable_i2c_mux(struct msm_camera_i2c_conf *i2c_conf)
{
...
static int32_t s5k5cagx_sensor_disable_i2c_mux(struct msm_camera_i2c_conf *i2c_conf)
{
	struct v4l2_subdev *i2c_mux_sd =
		dev_get_drvdata(&i2c_conf->mux_dev->dev);
	v4l2_subdev_call(i2c_mux_sd, core, ioctl,
...
int32_t s5k5cagx_sensor_power_up(struct msm_sensor_ctrl_t *s_ctrl)
{
	int32_t rc = 0;
	int32_t index = 0;
	...
	{
				int r_v =0;
				r_v = gpio_request(98, "SENSOR_SID");
			if (r_v) {
				pr_err("%s gpio_request failed %d\n", __func__, __LINE__);
				return r_v;

			}
			gpio_tlmm_config(GPIO_CFG(98, 0,
	...
	for (index = 0; index < power_setting_array->size; index++) {
		...
		case SENSOR_I2C_MUX:
			if (data->i2c_conf && data->i2c_conf->use_i2c_mux)
				s5k5cagx_sensor_enable_i2c_mux(data->i2c_conf);
			break;
		default:
...
power_up_failed:
	...
	for (index = 0; index < power_setting_array->size; index++){
		...
		case SENSOR_I2C_MUX:
			if (data->i2c_conf && data->i2c_conf->use_i2c_mux)
				s5k5cagx_sensor_disable_i2c_mux(data->i2c_conf);
			break;
		default:
			pr_err("%s error power seq type %d\n", __func__,
				power_setting->seq_type);
...
int32_t s5k5cagx_sensor_power_down(struct msm_sensor_ctrl_t *s_ctrl)
{
	int32_t index = 0;
	struct msm_sensor_power_setting_array *power_setting_array = NULL;
	struct msm_sensor_power_setting *power_setting = NULL;
...
static int32_t s5k5cagx_platform_probe(struct platform_device *pdev)
{
	int32_t rc;
	const struct of_device_id *match;
	match = of_match_device(s5k5cagx_dt_match, &pdev->dev);
	rc = msm_sensor_platform_probe(pdev, match->data);
	return rc;
}

static int __init s5k5cagx_init_module(void)
{
	int32_t rc;
	pr_info("%s:%d\n", __func__, __LINE__);
	rc = platform_driver_probe(&s5k5cagx_platform_driver,
		s5k5cagx_platform_probe);
	if (!rc)
		return rc;
	return i2c_add_driver(&s5k5cagx_i2c_driver);
}

static void __exit s5k5cagx_exit_module(void)
{
	pr_info("%s:%d\n", __func__, __LINE__);
	if (s5k5cagx_s_ctrl.pdev) {
		msm_sensor_free_sensor_data(&s5k5cagx_s_ctrl);
		platform_driver_unregister(&s5k5cagx_platform_driver);
	} else
		i2c_del_driver(&s5k5cagx_i2c_driver);
	return;
}

static int32_t s5k5cagx_sensor_match_id(struct msm_sensor_ctrl_t *s_ctrl)
{
	int32_t rc = 0;
	uint16_t chipid = 0;
	...
	rc = s_ctrl->sensor_i2c_client->i2c_func_tbl->
			i2c_write(
			s_ctrl->sensor_i2c_client, 0xFCFC,
			0x0000,
			MSM_CAMERA_I2C_WORD_DATA);
	...
	if (rc < 0) {
		pr_err("%s: %s:s5k5cga s5k5cagx read id failed\n", __func__,
...
static void s5k5cagx_set_stauration(struct msm_sensor_ctrl_t *s_ctrl, int value)
{
	CDBG("%s %d\n", __func__, value);

	#ifndef BENZ_TEMP_MASK
	s5k5cagx_i2c_write_table(s_ctrl, &s5k5cagx_reg_saturation[value][0],
		ARRAY_SIZE(s5k5cagx_reg_saturation[value]));
	#endif
}

static void s5k5cagx_set_contrast(struct msm_sensor_ctrl_t *s_ctrl, int value)
{
	CDBG("%s %d\n", __func__, value);
	#ifndef BENZ_TEMP_MASK
	s5k5cagx_i2c_write_table(s_ctrl, &s5k5cagx_reg_contrast[value][0],
		ARRAY_SIZE(s5k5cagx_reg_contrast[value]));
	#endif
}
#if 0
/*do not support set brightness for the moment*/
static void s5k5cagx_set_brightness(struct msm_sensor_ctrl_t *s_ctrl, int value)
{
	CDBG("%s %d\n", __func__, value);
	s5k5cagx_i2c_write_table(s_ctrl, &s5k5cagx_reg_brightness[value][0],
		ARRAY_SIZE(s5k5cagx_reg_brightness[value]));
}
#endif
static void s5k5cagx_set_sharpness(struct msm_sensor_ctrl_t *s_ctrl, int value)
{
	int val = value / 6;
	CDBG("%s %d\n", __func__, val);
	#ifndef BENZ_TEMP_MASK
	s5k5cagx_i2c_write_table(s_ctrl, &s5k5cagx_reg_sharpness[val][0],
		ARRAY_SIZE(s5k5cagx_reg_sharpness[val]));
	#endif
}


static void s5k5cagx_set_iso(struct msm_sensor_ctrl_t *s_ctrl, int value)
{
	CDBG("%s %d\n", __func__, value);
	#ifndef BENZ_TEMP_MASK
	s5k5cagx_i2c_write_table(s_ctrl, &s5k5cagx_reg_iso[value][0],
		ARRAY_SIZE(s5k5cagx_reg_iso[value]));
	#endif
}

static void s5k5cagx_set_exposure_compensation(struct msm_sensor_ctrl_t *s_ctrl,
	int value)
{
	int val = (value + 12) / 6;
	CDBG("%s %d\n", __func__, val);
	#ifndef BENZ_TEMP_MASK
	s5k5cagx_i2c_write_table(s_ctrl, &s5k5cagx_reg_exposure_compensation[val][0],
		ARRAY_SIZE(s5k5cagx_reg_exposure_compensation[val]));
	#endif
}

static void s5k5cagx_set_effect(struct msm_sensor_ctrl_t *s_ctrl, int value)
{
	CDBG("%s %d\n", __func__, value);
	#ifndef BENZ_TEMP_MASK
	switch (value) {
	case MSM_CAMERA_EFFECT_MODE_OFF: {
		s5k5cagx_i2c_write_table(s_ctrl, &s5k5cagx_reg_effect_normal[0],
			ARRAY_SIZE(s5k5cagx_reg_effect_normal));
		break;
	}
	case MSM_CAMERA_EFFECT_MODE_MONO: {
		s5k5cagx_i2c_write_table(s_ctrl, &s5k5cagx_reg_effect_black_white[0],
			ARRAY_SIZE(s5k5cagx_reg_effect_black_white));
		break;
	}
	case MSM_CAMERA_EFFECT_MODE_NEGATIVE: {
		s5k5cagx_i2c_write_table(s_ctrl, &s5k5cagx_reg_effect_negative[0],
			ARRAY_SIZE(s5k5cagx_reg_effect_negative));
		break;
	}
	case MSM_CAMERA_EFFECT_MODE_SEPIA: {
		s5k5cagx_i2c_write_table(s_ctrl, &s5k5cagx_reg_effect_old_movie[0],
			ARRAY_SIZE(s5k5cagx_reg_effect_old_movie));
		break;
	}
	case MSM_CAMERA_EFFECT_MODE_SOLARIZE: {
		s5k5cagx_i2c_write_table(s_ctrl, &s5k5cagx_reg_effect_solarize[0],
			ARRAY_SIZE(s5k5cagx_reg_effect_solarize));
		break;
	}
	case MSM_CAMERA_EFFECT_MODE_AQUA: {
		s5k5cagx_i2c_write_table(s_ctrl, &s5k5cagx_reg_effect_aqua[0],
			ARRAY_SIZE(s5k5cagx_reg_effect_aqua));
		break;
	}
	default:
		s5k5cagx_i2c_write_table(s_ctrl, &s5k5cagx_reg_effect_normal[0],
...
static void s5k5cagx_set_antibanding(struct msm_sensor_ctrl_t *s_ctrl, int value)
{
	CDBG("%s %d\n", __func__, value);
	#ifndef BENZ_TEMP_MASK
	s5k5cagx_i2c_write_table(s_ctrl, &s5k5cagx_reg_antibanding[value][0],
		ARRAY_SIZE(s5k5cagx_reg_antibanding[value]));
	#endif
}

static void s5k5cagx_set_scene_mode(struct msm_sensor_ctrl_t *s_ctrl, int value)
{
	CDBG("%s %d\n", __func__, value);
	#ifndef BENZ_TEMP_MASK
	switch (value) {
	case MSM_CAMERA_SCENE_MODE_OFF: {
		s5k5cagx_i2c_write_table(s_ctrl, &s5k5cagx_reg_scene_auto[0],
			ARRAY_SIZE(s5k5cagx_reg_scene_auto));
		break;
	}
	case MSM_CAMERA_SCENE_MODE_NIGHT: {
		s5k5cagx_i2c_write_table(s_ctrl, &s5k5cagx_reg_scene_night[0],
			ARRAY_SIZE(s5k5cagx_reg_scene_night));
		break;
	}
	case MSM_CAMERA_SCENE_MODE_LANDSCAPE: {
		s5k5cagx_i2c_write_table(s_ctrl, &s5k5cagx_reg_scene_landscape[0],
			ARRAY_SIZE(s5k5cagx_reg_scene_landscape));
		break;
	}
	case MSM_CAMERA_SCENE_MODE_PORTRAIT: {
		s5k5cagx_i2c_write_table(s_ctrl, &s5k5cagx_reg_scene_portrait[0],
			ARRAY_SIZE(s5k5cagx_reg_scene_portrait));
		break;
	}
	default:
		s5k5cagx_i2c_write_table(s_ctrl, &s5k5cagx_reg_scene_auto[0],
...
static void s5k5cagx_set_white_balance_mode(struct msm_sensor_ctrl_t *s_ctrl,
	int value)
{
	CDBG("%s %d\n", __func__, value);
	#ifndef BENZ_TEMP_MASK
	...
	case MSM_CAMERA_WB_MODE_AUTO: {
		s5k5cagx_i2c_write_table(s_ctrl, &s5k5cagx_reg_wb_auto[0],
			ARRAY_SIZE(s5k5cagx_reg_wb_auto));
		break;
	}
	case MSM_CAMERA_WB_MODE_INCANDESCENT: {
		s5k5cagx_i2c_write_table(s_ctrl, &s5k5cagx_reg_wb_home[0],
			ARRAY_SIZE(s5k5cagx_reg_wb_home));
		break;
	}
	case MSM_CAMERA_WB_MODE_DAYLIGHT: {
		s5k5cagx_i2c_write_table(s_ctrl, &s5k5cagx_reg_wb_sunny[0],
			ARRAY_SIZE(s5k5cagx_reg_wb_sunny));
		break;
	}
	case MSM_CAMERA_WB_MODE_FLUORESCENT: {
		s5k5cagx_i2c_write_table(s_ctrl, &s5k5cagx_reg_wb_office[0],
			ARRAY_SIZE(s5k5cagx_reg_wb_office));
		break;
	}
	case MSM_CAMERA_WB_MODE_CLOUDY_DAYLIGHT: {
		s5k5cagx_i2c_write_table(s_ctrl, &s5k5cagx_reg_wb_cloudy[0],
			ARRAY_SIZE(s5k5cagx_reg_wb_cloudy));
		break;
	}
	default:
		s5k5cagx_i2c_write_table(s_ctrl, &s5k5cagx_reg_wb_auto[0],
...
int32_t s5k5cagx_sensor_config(struct msm_sensor_ctrl_t *s_ctrl,
	void __user *argp)
{
	...
	case CFG_SET_INIT_SETTING:
		CDBG("init setting\n");
				...
				pr_err("%s,----s5k5cag--- sensor write init setting!!", __func__);
				s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_read(	s_ctrl->sensor_i2c_client,0x0f12,&id, MSM_CAMERA_I2C_WORD_DATA);
				size = sizeof(s5k5cagx_recommend_settings_step0)/sizeof(s5k5cagx_recommend_settings_step0[0]);
				for(i = 0; i < size; i++) {
					if (0xFFFF == s5k5cagx_recommend_settings_step0[i].reg_addr) {
					//	printk(KERN_ERR "sleep %dms before", (s5k5cagx_recommend_settings_step0[i].reg_data & 0xff00) >> 8);
						msleep((s5k5cagx_recommend_settings_step0[i].reg_data & 0xff00) >> 8);
					//	printk(KERN_ERR "sleep %dms after", (s5k5cagx_recommend_settings_step0[i].reg_data & 0xff00) >> 8);
					} else {
						rc = s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write(	s_ctrl->sensor_i2c_client,s5k5cagx_recommend_settings_step0[i].reg_addr&0xffff,s5k5cagx_recommend_settings_step0[i].reg_data&0xffff, MSM_CAMERA_I2C_WORD_DATA);
						if(rc<0)
							printk(KERN_ERR "---s5k5cagx_recommend_settings_step0[%d].reg_addr:0x%x-----\n  ",i,s5k5cagx_recommend_settings_step0[i].reg_addr);
					}
				}	
	...
	case CFG_SET_RESOLUTION: {
		...
		if (0 == val)//capture resolution
		{
			s5k5cagx_i2c_write_table(s_ctrl, &s5k5cagx_2048x1536_settings[0],
				ARRAY_SIZE(s5k5cagx_2048x1536_settings));
		}
		else if (1 == val)//preview resolution
		{
			s5k5cagx_i2c_write_table(s_ctrl, &s5k5cagx_1024x768_settings[0],
				ARRAY_SIZE(s5k5cagx_1024x768_settings));
		}
		else
		{
			printk("error resolution.\n");
		}
		CDBG("resolutin setting %d X\n",val);
		mdelay(100);
		break;
	}
	case CFG_SET_STOP_STREAM:
		CDBG("stop stream\n");
		s5k5cagx_i2c_write_table(s_ctrl,
			&s5k5cagx_stop_settings[0],
			ARRAY_SIZE(s5k5cagx_stop_settings));
		CDBG("stop stream X\n");
		break;
	case CFG_SET_START_STREAM:
		CDBG("start stream\n");
		s5k5cagx_i2c_write_table(s_ctrl,
			&s5k5cagx_start_settings[0],
			ARRAY_SIZE(s5k5cagx_start_settings));
		CDBG("start stream x\n");
		break;
	...
	case CFG_SET_SATURATION: {
		...
		CDBG("set Saturation\n");
		s5k5cagx_set_stauration(s_ctrl, sat_lev);
	...
	case CFG_SET_CONTRAST: {
		...
		CDBG("set contrast\n");
		s5k5cagx_set_contrast(s_ctrl, con_lev);
		CDBG("set contrast X\n");
		break;
	}
	case CFG_SET_SHARPNESS: {
		...
		CDBG("set SHARPNESS\n");
		s5k5cagx_set_sharpness(s_ctrl, shp_lev);
	...
	case CFG_SET_BRIGHTNESS: {
		...
		CDBG("set BRIGHTNESS\n");
		s5k5cagx_set_brightness(s_ctrl, bri_lev);
	...
	case CFG_SET_ISO: {
		...
		CDBG("set iso\n");
		s5k5cagx_set_iso(s_ctrl, iso_lev);
		CDBG("set iso X\n");
		break;
	}
	case CFG_SET_EXPOSURE_COMPENSATION: {
		...
		CDBG("%s: Exposure compensation Value is %d\n",
			__func__, ec_lev);
		CDBG("set exposure\n");
		s5k5cagx_set_exposure_compensation(s_ctrl, ec_lev);
		CDBG("Set exposure X\n");
		break;
	}
	case CFG_SET_EFFECT: {
		...
		CDBG("Set effect\n");
		s5k5cagx_set_effect(s_ctrl, effect_mode);
		CDBG("Set effect X\n");
		break;
	}
	case CFG_SET_ANTIBANDING: {
		...
		s5k5cagx_set_antibanding(s_ctrl, antibanding_mode);
	...
	case CFG_SET_BESTSHOT_MODE: {
		...
		CDBG("Set scene mode\n");
		s5k5cagx_set_scene_mode(s_ctrl, bs_mode);
	...
	case CFG_SET_WHITE_BALANCE: {
		...
		CDBG("Set wb\n");
		s5k5cagx_set_white_balance_mode(s_ctrl, wb_mode);
		CDBG("Set wb X\n");
		break;
	}
	default:
...
/****************************************************************************
* FunctionName: s5k5cagx_add_project_name;
* Description : add the project name and app_info display;
***************************************************************************/
static int s5k5cagx_add_project_name(struct msm_sensor_ctrl_t *s_ctrl)
{
	...
	strncpy(s_ctrl->sensordata->sensor_info->sensor_project_name, "23060073FF-Hy-F", strlen("23060073FF-Hy-F")+1);

	/*add the app_info*/
	app_info_set("camera_main", "s5k5cagx_sunny");

	pr_info("s5k5cagx_add_project_name OK\n");

	return 0;
}

static struct msm_sensor_fn_t s5k5cagx_sensor_func_tbl = {
	.sensor_config = s5k5cagx_sensor_config,
	.sensor_power_up = s5k5cagx_sensor_power_up,
	.sensor_power_down = s5k5cagx_sensor_power_down,
	.sensor_match_id = s5k5cagx_sensor_match_id,
#ifdef CONFIG_HUAWEI_KERNEL_CAMERA
	.sensor_add_project_name = s5k5cagx_add_project_name,
#endif
};

static struct msm_sensor_ctrl_t s5k5cagx_s_ctrl = {
	.sensor_i2c_client = &s5k5cagx_sensor_i2c_client,
	.power_setting_array.power_setting = s5k5cagx_power_setting,
	.power_setting_array.size = ARRAY_SIZE(s5k5cagx_power_setting),
	.msm_sensor_mutex = &s5k5cagx_mut,
	.sensor_v4l2_subdev_info = s5k5cagx_subdev_info,
	.sensor_v4l2_subdev_info_size = ARRAY_SIZE(s5k5cagx_subdev_info),
	.func_tbl = &s5k5cagx_sensor_func_tbl,
#ifdef CONFIG_HUAWEI_KERNEL_CAMERA
	.power_down_setting_array.power_setting = s5k5cagx_power_down_setting,
	.power_down_setting_array.size = ARRAY_SIZE(s5k5cagx_power_down_setting),
#endif
};

module_init(s5k5cagx_init_module);
module_exit(s5k5cagx_exit_module);
MODULE_DESCRIPTION("S5k5cagx 3MP YUV sensor driver");
