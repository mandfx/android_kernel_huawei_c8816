...
/*===========================================================================
 * FUNCTION    - mt9v113_customize_config -
 * DESCRIPTION:  config sensor mirror/flip as product dts file
 *==========================================================================*/
void mt9v113_customize_config(struct msm_sensor_ctrl_t *s_ctrl)
{
	int i=0, flip_mirror_value=0, flip_time=0;
		...
		"qcom,flip-mirror-value", &flip_mirror_value))
	{
		...
		if(1 == flip_mirror_value)
		{
			...
			for(i=0; i<ARRAY_SIZE(mt9v113_recommend_settings_4); i++)
			if (0x2717 == mt9v113_recommend_settings_4[i].reg_data
			|| 0x272D == mt9v113_recommend_settings_4[i].reg_data)
			{
				mt9v113_recommend_settings_4[i+1].reg_data =  0x26;
				flip_time ++;
...
static int mt9v113_add_project_name(struct msm_sensor_ctrl_t *s_ctrl)
{
    ...
    mt9v113_customize_config(s_ctrl);
